...
Altered to train on an insect dataset by Daria Gurtovoy
...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    python3 insect.py splash --weights=/path/to/weights/file.h5 --image=<URL or path to file>

    # Apply color splash to video using the last weights you trained
    python3 insect.py splash --weights=last --video=<URL or path to file>
"""
